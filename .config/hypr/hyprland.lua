...
hl.config({
  misc = {
    ...
    font_family = "Monospace" -- last time here
  }
})
...
local ctrlMod = "CTLR"   -- Sets "Windows" key as main modifier
local shiftMod = "SHIFT" -- Sets "Windows" key as main modifier
