...
opts = function()
  ...
  require("lualine").setup({
    ...
    sections = {
      lualine_a = {
        {
          function()
            local mode_map = {
              n = "🈚 ノーマル", i = "✍️ インサート", v = "👁️ ビジュアル",
              V = "📏 ビジュアルライン", [""] = "🔲 ビジュアルブロック",
              c = "⌨️ コマンド", R = "📝 リプレイス", s = "🔤 セレクト",
              S = "🧾 セレクトライン", t = "💻 ターミナル",
            }
      ...
      lualine_c = {
        { function() return vim.fn.fnamemodify(vim.fn.getcwd(), ":t") end, icon = " " },
  ...
  vim.defer_fn(function()
    if vim.g.lualine_full_loaded then return end
